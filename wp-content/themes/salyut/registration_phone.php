<?php
/*
    Template name: registration_phone
*/
// session_start();
                   ...
                   <section class="registration">
                       <div class="registration_wrapper">
                           ...
                           <form  class="registration_form_wrapper" action="<?php echo  admin_url('admin-post.php'); ?>" method="post">
                               <input type="hidden" name="action" value="registration_form2">
                               ...
                               <?php if(isset($_SESSION['error']['phone'])): ?>
                                ...
                                <?php endif; ?>
                                <input type="text" class="registration_form_input_field"  placeholder="+7 (___)___-__-__" id="registration_form_phone_input" name="phone">
                               </div>
                               <div class="registration_form_input_field_wrapper">
                               <?php if(isset($_SESSION['error']['user_phone'])): ?>
                                    <div class="alert-errors"><?php echo $_SESSION['error']['user_phone']; ?></div>
                                <?php endif; ?>
                               <?php if(isset($_SESSION['error']['password'])): ?>
                                    <div class="alert-errors"><?php echo $_SESSION['error']['password']; ?></div>
                                <?php endif; ?>
                                   <input type="text" class="registration_form_input_field" placeholder="Пароль" name="password" >
                               </div>
                               ...
                               <?php if(isset($_SESSION['error']['agree2'])): ?>
                                        <div class="alert-errors"><?php echo $_SESSION['error']['agree2']; ?></div>
                                     <?php endif; ?>
                               <a href="/регистрация/" class="registration_form_link1" id="registration_with_password">Регистрация по логину и паролю</a>
                             <button type="submit" class="registration_form_btn"><span>Зарегистрироваться</span></button>
                               <a href="/авторизация/" class="registration_form_link2" id="registration_with_phone1">Войти по номеру телефона</a>
