...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '2021125_salyut_06b6809922a71c258102_20220521085854_archive.zip';
	const ARCHIVE_SIZE		 = '55807273';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '06b6809-21085854';
    const SECONDARY_PACKAGE_HASH = '8507e7d-21085854';
	const VERSION			 = '1.4.3';
